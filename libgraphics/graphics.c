 ...
 * Type: graphicsStateT
 * --------------------
 * This structure holds the variables that make up the graphics ball_state.
 */
 ...
 * Type: regionStateT
 * ------------------
 * The region assembly process has the character of a finite ball_state
 ...
 *
 * The current ball_state determines whether other operations are legal
 * at that point.
 */
 ...
 * regionState    -- Current ball_state of the region
 ...
 * ---------------------------
 * This function initializes the graphics ball_state elements to
 * their default values.  Because the erase mode and font
 * information are also maintained in the display ball_state,
