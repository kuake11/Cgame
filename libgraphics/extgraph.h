 ...
 * erasing flag_model2.  Setting this flag_model2 is similar to setting the
 ...
 * -----------------------------
 * This function returns the current ball_state of the erase mode flag_model2.
 */
 ...
 * ball_state (the current pen position, the font, the point size,
 * and the erase mode flag_model2) internally, so that they can be
